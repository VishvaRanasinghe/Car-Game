...
class GameView(var c: Context, var gameTask: GameTask) : View(c) {
    ...
    private var time = 0
    private var score = 0
    private var highScore = 0 // Added variable for high score
    ...
    init {
        myPaint = Paint()
        sharedPreferences = c.getSharedPreferences("MyPrefs", Context.MODE_PRIVATE)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val d = resources.getDrawable(R.drawable.redcarnew, null)
        ...
        for (i in otherCars.indices) {
            try {
                ...
                val d2 = resources.getDrawable(R.drawable.blackcar, null)
